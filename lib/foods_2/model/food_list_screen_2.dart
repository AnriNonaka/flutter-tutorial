...
//
// //2つ目の方法：inputDialogを別クラス・StatefullWidgetで作る方法
//
...
//   }
//
//   // List<String>? getEnableTags(Map<String, bool> tags)async {
//   //   List<String> enableTags = [];
//   //   // ここで絞り込みを行う
//   //   // HashMap. keyのListを取得できる。このリストを使って、ループを行って、フィルターを使う
//   //   enableTags = getEnableTags.where((String key, bool value) => await value);
//   //   //ここで上限5個のやつも入れる
//   //   return enableTags;
//   // }
//
